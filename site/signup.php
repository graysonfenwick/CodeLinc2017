...
//	echo $row['Name'];
//}
$stmt=$db->prepare("INSERT INTO person (Name, Address, County, FacebookUsername,Email,PhoneNum,MonthlyGrossIncome, NumInHousehold,ReceiveFoodStamp,DateFoodReceived)
values (:name, :address, :county, :fbusername, :email, :phonenumber, :income, :numpeople, :yesfood, :date)");
