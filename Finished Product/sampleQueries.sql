...
insert into event
    ...
    values ("123 Sesame St.", "2017-10-15", "Provider1");
...
insert into event
    (Location, Date, Provider)
    values ("Food Dr.", "2017-10-15", "Provider2");
...
insert into attendance
    ...
    values ("realJB@gmail.com", "123 Sesame St.", "2017-10-15", "Provider1");
...
insert into attendance
    (PersonEmail, EventLocation, EventDate, EventProvider)
    values ("cakeEater@gmail.com", "Food Dr.", "2017-10-15", "Provider2");
...
insert into attendance
    (PersonEmail, EventLocation, EventDate, EventProvider)
    values ("cakeEater@gmail.com", "123 Sesame St.", "2017-10-15", "Provider1");
